...
var IosCloudDownloadOutline = React.createClass({
	displayName: 'IosCloudDownloadOutline',
		...
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					'g',
					null,
					React.createElement('polygon', { points: '193.2,381.2 181.6,392.6 256.1,466 330.6,392.6 319,381.2 264.3,435 264.3,192.9 247.9,192.9 247.9,435 \t\t' })
				),
				React.createElement(
					'g',
					null,
