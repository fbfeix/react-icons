...
export default class IosArrowThinRight extends React.Component {
	render() {
if(this.props.bare) {
			return <g>
...
<path d="M322.2,349.7c-3.1-3.1-3-8,0-11.3l66.4-74.4H104c-4.4,0-8-3.6-8-8c0-4.4,3.6-8,8-8h284.6l-66.3-74.4
	...
	c-1.5,1.5-3.6,2.3-5.7,2.3C325.8,352,323.8,351.2,322.2,349.7z"></path>
...
};IosArrowThinRight.defaultProps = {bare: false}