...
export default class IosArrowThinDown extends React.Component {
	render() {
if(this.props.bare) {
			return <g>
...
<path d="M349.7,322.2c-3.1-3.1-8-3-11.3,0L264,388.6V104c0-4.4-3.6-8-8-8c-4.4,0-8,3.6-8,8v284.6l-74.4-66.3
	...
	c1.5-1.5,2.3-3.6,2.3-5.7C352,325.8,351.2,323.8,349.7,322.2z"></path>
...
};IosArrowThinDown.defaultProps = {bare: false}