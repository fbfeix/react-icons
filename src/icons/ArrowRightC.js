...
export default class ArrowRightC extends React.Component {
	render() {
if(this.props.bare) {
			return <g>
...
<path d="M322.7,128.4L423,233.4c6,5.8,9,13.7,9,22.4c0,8.7-3,16.5-9,22.4L322.7,383.6c-11.9,12.5-31.3,12.5-43.2,0
	...
	c-11.9-12.5-11.9-32.7,0-45.2C291.4,115.9,310.7,115.9,322.7,128.4z"></path>
...
};ArrowRightC.defaultProps = {bare: false}