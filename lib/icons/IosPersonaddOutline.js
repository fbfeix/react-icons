...
var IosPersonaddOutline = function (_React$Component) {
	_inherits(IosPersonaddOutline, _React$Component);

	function IosPersonaddOutline() {
		_classCallCheck(this, IosPersonaddOutline);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(IosPersonaddOutline).apply(this, arguments));
	}
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'g',
							null,
							_react2.default.createElement('path', { d: 'M202.4,201.7C202.4,201.7,202.4,201.7,202.4,201.7L202.4,201.7z' }),
...
;IosPersonaddOutline.defaultProps = { bare: false };