...
var IosFlag = function (_React$Component) {
	_inherits(IosFlag, _React$Component);

	function IosFlag() {
		_classCallCheck(this, IosFlag);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(IosFlag).apply(this, arguments));
	}
...
;IosFlag.defaultProps = { bare: false };