...
var IosColorFilterOutline = function (_React$Component) {
	_inherits(IosColorFilterOutline, _React$Component);

	function IosColorFilterOutline() {
		_classCallCheck(this, IosColorFilterOutline);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(IosColorFilterOutline).apply(this, arguments));
	}
...
;IosColorFilterOutline.defaultProps = { bare: false };