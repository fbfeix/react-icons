...
var IosTelephoneOutline = function (_React$Component) {
	_inherits(IosTelephoneOutline, _React$Component);

	function IosTelephoneOutline() {
		_classCallCheck(this, IosTelephoneOutline);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(IosTelephoneOutline).apply(this, arguments));
	}

	_createClass(IosTelephoneOutline, [{
		key: 'render',
	...
	return IosTelephoneOutline;
}(_react2.default.Component);

exports.default = IosTelephoneOutline;
;IosTelephoneOutline.defaultProps = { bare: false };