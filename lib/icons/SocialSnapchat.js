...
var SocialSnapchat = function (_React$Component) {
	_inherits(SocialSnapchat, _React$Component);

	function SocialSnapchat() {
		_classCallCheck(this, SocialSnapchat);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(SocialSnapchat).apply(this, arguments));
	}

	_createClass(SocialSnapchat, [{
		key: 'render',
...
exports.default = SocialSnapchat;
;