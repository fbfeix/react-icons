...
var IosGear = function (_React$Component) {
	_inherits(IosGear, _React$Component);

	function IosGear() {
		_classCallCheck(this, IosGear);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(IosGear).apply(this, arguments));
	}

	_createClass(IosGear, [{
		key: 'render',
...
exports.default = IosGear;
;IosGear.defaultProps = { bare: false };