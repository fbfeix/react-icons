...
var IosAt = function (_React$Component) {
	_inherits(IosAt, _React$Component);

	function IosAt() {
		_classCallCheck(this, IosAt);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(IosAt).apply(this, arguments));
	}
