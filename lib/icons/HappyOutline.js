...
var HappyOutline = function (_React$Component) {
	_inherits(HappyOutline, _React$Component);

	function HappyOutline() {
		_classCallCheck(this, HappyOutline);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(HappyOutline).apply(this, arguments));
	}

	_createClass(HappyOutline, [{
		key: 'render',
...
;HappyOutline.defaultProps = { bare: false };