...
var SocialTux = function (_React$Component) {
	_inherits(SocialTux, _React$Component);

	function SocialTux() {
		_classCallCheck(this, SocialTux);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(SocialTux).apply(this, arguments));
	}

	_createClass(SocialTux, [{
		key: 'render',
