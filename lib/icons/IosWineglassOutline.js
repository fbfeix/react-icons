...
var IosWineglassOutline = function (_React$Component) {
	_inherits(IosWineglassOutline, _React$Component);

	function IosWineglassOutline() {
		_classCallCheck(this, IosWineglassOutline);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(IosWineglassOutline).apply(this, arguments));
	}

	_createClass(IosWineglassOutline, [{
		key: 'render',
	...
	return IosWineglassOutline;
}(_react2.default.Component);

exports.default = IosWineglassOutline;
;IosWineglassOutline.defaultProps = { bare: false };