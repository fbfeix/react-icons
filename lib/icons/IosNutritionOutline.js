...
var IosNutritionOutline = function (_React$Component) {
	_inherits(IosNutritionOutline, _React$Component);

	function IosNutritionOutline() {
		_classCallCheck(this, IosNutritionOutline);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(IosNutritionOutline).apply(this, arguments));
	}
