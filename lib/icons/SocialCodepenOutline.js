...
var SocialCodepenOutline = function (_React$Component) {
	_inherits(SocialCodepenOutline, _React$Component);

	function SocialCodepenOutline() {
		_classCallCheck(this, SocialCodepenOutline);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(SocialCodepenOutline).apply(this, arguments));
	}

	_createClass(SocialCodepenOutline, [{
		key: 'render',
	...
	return SocialCodepenOutline;
}(_react2.default.Component);

exports.default = SocialCodepenOutline;
;SocialCodepenOutline.defaultProps = { bare: false };