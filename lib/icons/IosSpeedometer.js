...
var IosSpeedometer = function (_React$Component) {
	_inherits(IosSpeedometer, _React$Component);

	function IosSpeedometer() {
		_classCallCheck(this, IosSpeedometer);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(IosSpeedometer).apply(this, arguments));
	}
...
;IosSpeedometer.defaultProps = { bare: false };