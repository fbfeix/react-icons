...
var ChevronRight = function (_React$Component) {
	_inherits(ChevronRight, _React$Component);

	function ChevronRight() {
		_classCallCheck(this, ChevronRight);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(ChevronRight).apply(this, arguments));
	}
...
;ChevronRight.defaultProps = { bare: false };