...
var AndroidWifi = function (_React$Component) {
	_inherits(AndroidWifi, _React$Component);

	function AndroidWifi() {
		_classCallCheck(this, AndroidWifi);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(AndroidWifi).apply(this, arguments));
	}

	_createClass(AndroidWifi, [{
		key: 'render',
...
exports.default = AndroidWifi;
;AndroidWifi.defaultProps = { bare: false };