...
var IosReverseCameraOutline = function (_React$Component) {
	_inherits(IosReverseCameraOutline, _React$Component);

	function IosReverseCameraOutline() {
		_classCallCheck(this, IosReverseCameraOutline);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(IosReverseCameraOutline).apply(this, arguments));
	}
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'g',
					null,
					_react2.default.createElement('path', { d: 'M301.815,318.608c-13.114,11.029-28.956,17.356-45.815,17.356c-36.36,0-66.286-28.965-70.89-61.965h30.61l-38.87-50 l-37.534,50h29.479c4.696,42,41.717,78,87.205,78c20.9,0,41.17-7.566,57.076-21.218l2.37-2.159l-11.599-11.662L301.815,318.608z' }),
					_react2.default.createElement('path', { d: 'M315.736,198.885c-16.188-14.775-37.402-22.839-59.736-22.839c-20.9,0-41.169,7.556-57.075,21.206l-2.371,2.052 l11.599,11.61l2.033-1.706c12.927-10.872,29.197-17.005,45.814-17.005c36.343,0,66.274,28.797,70.891,63.797h-30.644l38.846,51.225 L372.719,256h-29.512C340.966,236,331.275,213.064,315.736,198.885z' }),
