...
var IosBookmarksOutline = function (_React$Component) {
	_inherits(IosBookmarksOutline, _React$Component);

	function IosBookmarksOutline() {
		_classCallCheck(this, IosBookmarksOutline);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(IosBookmarksOutline).apply(this, arguments));
	}
...
;IosBookmarksOutline.defaultProps = { bare: false };