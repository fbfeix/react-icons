...
var SocialSkypeOutline = function (_React$Component) {
	_inherits(SocialSkypeOutline, _React$Component);

	function SocialSkypeOutline() {
		_classCallCheck(this, SocialSkypeOutline);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(SocialSkypeOutline).apply(this, arguments));
	}

	_createClass(SocialSkypeOutline, [{
		key: 'render',
...
exports.default = SocialSkypeOutline;
;SocialSkypeOutline.defaultProps = { bare: false };