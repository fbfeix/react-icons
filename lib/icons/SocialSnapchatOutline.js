...
var SocialSnapchatOutline = function (_React$Component) {
	_inherits(SocialSnapchatOutline, _React$Component);

	function SocialSnapchatOutline() {
		_classCallCheck(this, SocialSnapchatOutline);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(SocialSnapchatOutline).apply(this, arguments));
	}

	_createClass(SocialSnapchatOutline, [{
		key: 'render',
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement('ellipse', { cx: '208', cy: '152', rx: '16', ry: '24' }),
					_react2.default.createElement('ellipse', { cx: '304', cy: '152', rx: '16', ry: '24' })
				)
			);
		}
	}]);

	return SocialSnapchatOutline;
}(_react2.default.Component);

exports.default = SocialSnapchatOutline;
;