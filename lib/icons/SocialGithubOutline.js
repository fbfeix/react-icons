...
var SocialGithubOutline = function (_React$Component) {
	_inherits(SocialGithubOutline, _React$Component);

	function SocialGithubOutline() {
		_classCallCheck(this, SocialGithubOutline);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(SocialGithubOutline).apply(this, arguments));
	}

	_createClass(SocialGithubOutline, [{
		key: 'render',
	...
	return SocialGithubOutline;
}(_react2.default.Component);

exports.default = SocialGithubOutline;
;SocialGithubOutline.defaultProps = { bare: false };