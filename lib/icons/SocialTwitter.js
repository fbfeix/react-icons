...
var SocialTwitter = function (_React$Component) {
	_inherits(SocialTwitter, _React$Component);

	function SocialTwitter() {
		_classCallCheck(this, SocialTwitter);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(SocialTwitter).apply(this, arguments));
	}

	_createClass(SocialTwitter, [{
		key: 'render',
...
;SocialTwitter.defaultProps = { bare: false };