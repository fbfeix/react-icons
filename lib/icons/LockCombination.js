...
var LockCombination = function (_React$Component) {
	_inherits(LockCombination, _React$Component);

	function LockCombination() {
		_classCallCheck(this, LockCombination);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(LockCombination).apply(this, arguments));
	}

	_createClass(LockCombination, [{
		key: 'render',
			...
			if (this.props.bare) {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement('circle', { cx: '256', cy: '320', r: '81' })
					)
				);
			}return _react2.default.createElement(
				_IconBase2.default,
...
exports.default = LockCombination;
;LockCombination.defaultProps = { bare: false };