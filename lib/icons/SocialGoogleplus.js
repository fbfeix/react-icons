...
var SocialGoogleplus = function (_React$Component) {
	_inherits(SocialGoogleplus, _React$Component);

	function SocialGoogleplus() {
		_classCallCheck(this, SocialGoogleplus);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(SocialGoogleplus).apply(this, arguments));
	}

	_createClass(SocialGoogleplus, [{
		key: 'render',
			...
			if (this.props.bare) {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement('polygon', { points: '402,142 402,64 368,64 368,142 288,142 288,176 368,176 368,257 402,257 402,176 480,176 480,142 \t' })
					)
				);
			}return _react2.default.createElement(
				_IconBase2.default,
...
exports.default = SocialGoogleplus;
;SocialGoogleplus.defaultProps = { bare: false };