...
var IosBaseballOutline = function (_React$Component) {
	_inherits(IosBaseballOutline, _React$Component);

	function IosBaseballOutline() {
		_classCallCheck(this, IosBaseballOutline);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(IosBaseballOutline).apply(this, arguments));
	}
