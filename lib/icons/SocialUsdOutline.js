...
var SocialUsdOutline = function (_React$Component) {
	_inherits(SocialUsdOutline, _React$Component);

	function SocialUsdOutline() {
		_classCallCheck(this, SocialUsdOutline);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(SocialUsdOutline).apply(this, arguments));
	}

	_createClass(SocialUsdOutline, [{
		key: 'render',
