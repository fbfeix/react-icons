...
var ChatbubbleWorking = function (_React$Component) {
	_inherits(ChatbubbleWorking, _React$Component);

	function ChatbubbleWorking() {
		_classCallCheck(this, ChatbubbleWorking);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(ChatbubbleWorking).apply(this, arguments));
	}

	_createClass(ChatbubbleWorking, [{
		key: 'render',
	...
	return ChatbubbleWorking;
}(_react2.default.Component);

exports.default = ChatbubbleWorking;
;ChatbubbleWorking.defaultProps = { bare: false };