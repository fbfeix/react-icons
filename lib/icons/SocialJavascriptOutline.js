...
var SocialJavascriptOutline = function (_React$Component) {
	_inherits(SocialJavascriptOutline, _React$Component);

	function SocialJavascriptOutline() {
		_classCallCheck(this, SocialJavascriptOutline);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(SocialJavascriptOutline).apply(this, arguments));
	}

	_createClass(SocialJavascriptOutline, [{
		key: 'render',
	...
	return SocialJavascriptOutline;
}(_react2.default.Component);

exports.default = SocialJavascriptOutline;
;SocialJavascriptOutline.defaultProps = { bare: false };