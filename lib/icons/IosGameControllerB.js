...
var IosGameControllerB = function (_React$Component) {
	_inherits(IosGameControllerB, _React$Component);

	function IosGameControllerB() {
		_classCallCheck(this, IosGameControllerB);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(IosGameControllerB).apply(this, arguments));
	}
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'g',
					null,
					_react2.default.createElement('path', { d: 'M135.123,204.568c-10.688,0-19.343,8.717-19.343,19.441c0,10.727,8.655,19.447,19.343,19.447 c10.641,0,19.297-8.721,19.297-19.447C154.42,213.285,145.764,204.568,135.123,204.568z' }),
