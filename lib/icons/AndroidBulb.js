...
var AndroidBulb = function (_React$Component) {
	_inherits(AndroidBulb, _React$Component);

	function AndroidBulb() {
		_classCallCheck(this, AndroidBulb);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(AndroidBulb).apply(this, arguments));
	}

	_createClass(AndroidBulb, [{
		key: 'render',
...
exports.default = AndroidBulb;
;AndroidBulb.defaultProps = { bare: false };