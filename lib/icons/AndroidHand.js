...
var AndroidHand = function (_React$Component) {
	_inherits(AndroidHand, _React$Component);

	function AndroidHand() {
		_classCallCheck(this, AndroidHand);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(AndroidHand).apply(this, arguments));
	}

	_createClass(AndroidHand, [{
		key: 'render',
...
exports.default = AndroidHand;
;AndroidHand.defaultProps = { bare: false };