...
var IosFootballOutline = function (_React$Component) {
	_inherits(IosFootballOutline, _React$Component);

	function IosFootballOutline() {
		_classCallCheck(this, IosFootballOutline);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(IosFootballOutline).apply(this, arguments));
	}
...
;IosFootballOutline.defaultProps = { bare: false };