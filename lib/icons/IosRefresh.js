...
var IosRefresh = function (_React$Component) {
	_inherits(IosRefresh, _React$Component);

	function IosRefresh() {
		_classCallCheck(this, IosRefresh);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(IosRefresh).apply(this, arguments));
	}
...
;IosRefresh.defaultProps = { bare: false };