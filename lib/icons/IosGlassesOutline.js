...
var IosGlassesOutline = function (_React$Component) {
	_inherits(IosGlassesOutline, _React$Component);

	function IosGlassesOutline() {
		_classCallCheck(this, IosGlassesOutline);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(IosGlassesOutline).apply(this, arguments));
	}
...
;IosGlassesOutline.defaultProps = { bare: false };