...
var IosBaseball = function (_React$Component) {
	_inherits(IosBaseball, _React$Component);

	function IosBaseball() {
		_classCallCheck(this, IosBaseball);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(IosBaseball).apply(this, arguments));
	}
