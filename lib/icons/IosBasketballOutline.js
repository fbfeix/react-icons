...
var IosBasketballOutline = function (_React$Component) {
	_inherits(IosBasketballOutline, _React$Component);

	function IosBasketballOutline() {
		_classCallCheck(this, IosBasketballOutline);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(IosBasketballOutline).apply(this, arguments));
	}
...
;IosBasketballOutline.defaultProps = { bare: false };