...
var Wineglass = function (_React$Component) {
	_inherits(Wineglass, _React$Component);

	function Wineglass() {
		_classCallCheck(this, Wineglass);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(Wineglass).apply(this, arguments));
	}

	_createClass(Wineglass, [{
		key: 'render',
...
;Wineglass.defaultProps = { bare: false };