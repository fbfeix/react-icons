...
var SocialSkype = function (_React$Component) {
	_inherits(SocialSkype, _React$Component);

	function SocialSkype() {
		_classCallCheck(this, SocialSkype);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(SocialSkype).apply(this, arguments));
	}

	_createClass(SocialSkype, [{
		key: 'render',
...
exports.default = SocialSkype;
;SocialSkype.defaultProps = { bare: false };