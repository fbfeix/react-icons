...
var IosAmericanfootballOutline = function (_React$Component) {
	_inherits(IosAmericanfootballOutline, _React$Component);

	function IosAmericanfootballOutline() {
		_classCallCheck(this, IosAmericanfootballOutline);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(IosAmericanfootballOutline).apply(this, arguments));
	}
...
;IosAmericanfootballOutline.defaultProps = { bare: false };