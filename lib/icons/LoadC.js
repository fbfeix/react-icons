...
var LoadC = function (_React$Component) {
	_inherits(LoadC, _React$Component);

	function LoadC() {
		_classCallCheck(this, LoadC);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(LoadC).apply(this, arguments));
	}
