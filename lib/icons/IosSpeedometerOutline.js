...
var IosSpeedometerOutline = function (_React$Component) {
	_inherits(IosSpeedometerOutline, _React$Component);

	function IosSpeedometerOutline() {
		_classCallCheck(this, IosSpeedometerOutline);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(IosSpeedometerOutline).apply(this, arguments));
	}
...
;IosSpeedometerOutline.defaultProps = { bare: false };