...
var Bluetooth = function (_React$Component) {
	_inherits(Bluetooth, _React$Component);

	function Bluetooth() {
		_classCallCheck(this, Bluetooth);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(Bluetooth).apply(this, arguments));
	}
...
;Bluetooth.defaultProps = { bare: false };