...
var IosAtOutline = function (_React$Component) {
	_inherits(IosAtOutline, _React$Component);

	function IosAtOutline() {
		_classCallCheck(this, IosAtOutline);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(IosAtOutline).apply(this, arguments));
	}
...
;IosAtOutline.defaultProps = { bare: false };