...
var SocialGoogleplusOutline = function (_React$Component) {
	_inherits(SocialGoogleplusOutline, _React$Component);

	function SocialGoogleplusOutline() {
		_classCallCheck(this, SocialGoogleplusOutline);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(SocialGoogleplusOutline).apply(this, arguments));
	}

	_createClass(SocialGoogleplusOutline, [{
		key: 'render',
	...
	return SocialGoogleplusOutline;
}(_react2.default.Component);

exports.default = SocialGoogleplusOutline;
;SocialGoogleplusOutline.defaultProps = { bare: false };