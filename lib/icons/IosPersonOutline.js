...
var IosPersonOutline = function (_React$Component) {
	_inherits(IosPersonOutline, _React$Component);

	function IosPersonOutline() {
		_classCallCheck(this, IosPersonOutline);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(IosPersonOutline).apply(this, arguments));
	}
			...
			if (this.props.bare) {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'g',
						null,
						_react2.default.createElement('path', { d: 'M202.4,201.7L202.4,201.7L202.4,201.7z' }),
...
;IosPersonOutline.defaultProps = { bare: false };