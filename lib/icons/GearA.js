...
var GearA = function (_React$Component) {
	_inherits(GearA, _React$Component);

	function GearA() {
		_classCallCheck(this, GearA);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(GearA).apply(this, arguments));
	}
...
exports.default = GearA;
;GearA.defaultProps = { bare: false };