...
var Trophy = function (_React$Component) {
	_inherits(Trophy, _React$Component);

	function Trophy() {
		_classCallCheck(this, Trophy);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(Trophy).apply(this, arguments));
	}
...
;Trophy.defaultProps = { bare: false };