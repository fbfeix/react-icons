...
var IosAnalyticsOutline = function (_React$Component) {
	_inherits(IosAnalyticsOutline, _React$Component);

	function IosAnalyticsOutline() {
		_classCallCheck(this, IosAnalyticsOutline);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(IosAnalyticsOutline).apply(this, arguments));
	}
...
;IosAnalyticsOutline.defaultProps = { bare: false };