...
var IosCogOutline = function (_React$Component) {
	_inherits(IosCogOutline, _React$Component);

	function IosCogOutline() {
		_classCallCheck(this, IosCogOutline);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(IosCogOutline).apply(this, arguments));
	}
...
;IosCogOutline.defaultProps = { bare: false };