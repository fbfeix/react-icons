...
var AndroidGlobe = function (_React$Component) {
	_inherits(AndroidGlobe, _React$Component);

	function AndroidGlobe() {
		_classCallCheck(this, AndroidGlobe);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(AndroidGlobe).apply(this, arguments));
	}

	_createClass(AndroidGlobe, [{
		key: 'render',
...
exports.default = AndroidGlobe;
;AndroidGlobe.defaultProps = { bare: false };