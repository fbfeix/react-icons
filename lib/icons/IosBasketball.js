...
var IosBasketball = function (_React$Component) {
	_inherits(IosBasketball, _React$Component);

	function IosBasketball() {
		_classCallCheck(this, IosBasketball);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(IosBasketball).apply(this, arguments));
	}
...
;IosBasketball.defaultProps = { bare: false };