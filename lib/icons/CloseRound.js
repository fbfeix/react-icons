...
var CloseRound = function (_React$Component) {
	_inherits(CloseRound, _React$Component);

	function CloseRound() {
		_classCallCheck(this, CloseRound);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(CloseRound).apply(this, arguments));
	}

	_createClass(CloseRound, [{
		key: 'render',
...
;CloseRound.defaultProps = { bare: false };