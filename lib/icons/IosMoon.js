...
var IosMoon = function (_React$Component) {
	_inherits(IosMoon, _React$Component);

	function IosMoon() {
		_classCallCheck(this, IosMoon);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(IosMoon).apply(this, arguments));
	}
...
;IosMoon.defaultProps = { bare: false };