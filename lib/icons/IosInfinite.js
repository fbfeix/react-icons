...
var IosInfinite = function (_React$Component) {
	_inherits(IosInfinite, _React$Component);

	function IosInfinite() {
		_classCallCheck(this, IosInfinite);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(IosInfinite).apply(this, arguments));
	}
